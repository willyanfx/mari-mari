export const test3 = [
  {
    id: 1,
    title: 'Vignette for questions 1-5',
    vignette: 'Common context for these questions goes here.',
    questions: [
      {
        id: 1,
        text: 'Q1. Based on this patient’s presentation, what syndrome are they suffering from?',
        options: {
          A: 'Horner syndrome',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 8,
        text: 'Q8. The patient returns 5 days later after seeing their doctor. An MRI revealed a grade III ACL tear. Swelling is still present but is significantly less than what was present on the patient’s last visit. The doctor has advised that they continue to use crutches and begin physiotherapy treatment to improve knee strength and range of motion. Given the patient’s diagnosis, what resting position would the physiotherapist expect to find the patient’s knee in?',
        options: {
          A: 'Full extension',
          B: '15-25 degrees of flexion',
      ...
      {
        id: 9,
        text: 'Q9. The physiotherapist is goal oriented to improve the patient’s knee ROM over the next few weeks of therapy. They are focused on improving knee extension. Which of the following is most likely the rationale behind the physiotherapist’s focus on improving full knee extension ROM over full knee flexion ROM?',
        options: {
          ...
          C: 'Full knee extension is required for a normal gait pattern.',
      ...
      {
        id: 10,
        text: 'Q10. During a follow up appointment, the patient arrives with their partner and the physiotherapist notices that the patient is slurring their speech and appears intoxicated. When confronted about this, the patient denies taking any drugs or alcohol and states they are just really tired. The physiotherapist still feels uncertain as to the sobriety of the patient. How should the physiotherapist proceed?',
        options: {
          A: 'Gain consent from the patient’s partner as the patient is unable to provide it for themself.',
          B: 'Carry on with treatment as the patient has denied taking any drugs or alcohol and the physiotherapist is not introducing any new treatment techniques today.',
          C: 'Educate the patient that treatment cannot be carried out today as the physiotherapist is uncertain if they have the capacity to provide consent.',
          D: 'Discharge the patient from treatment as they are a risk to both the physiotherapist and themself.',
        },
        correctAnswer: 'C',
        explanation:
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: 'D',
        explanation:
          '<div class="noselect"> <p style="text-align: left"> <strong>Feedback:</strong> </p> <p style="text-align: left"> A. Primitive reflexes are inhibited as the cortex develops. </p> <p style="text-align: left"> B. Primitive reflexes lay the foundation for higher-level motor and cognitive skills. </p> <p style="text-align: left"> C. Non-integrated reflexes impact the fluidity and smoothness with which an individual moves. </p> <p style="text-align: left"> D. Once a primitive reflex has been integrated, it will never return. <strong>– CORRECT</strong> </p> <ul style="text-align: left"> <li> This statement is incorrect and would thus not be included in the discussion about primitive reflexes. An adult who suffers a brain injury (e.g., CVA, TBI) may exhibit primitive reflexes affecting voluntary movement control and posture. </li> </ul> <p style="text-align: left"> O’Sullivan, S. B., &amp; Schmitz, T. J. (2007). Physical rehabilitation (5th ed.). Pg. 239. Philadelphia: F.A. Davis Company. </p> </div>',
      },
      {
        id: 17,
        text: 'vi. The infant will be able to demonstrate lateral head righting to the left side',
        options: {
          A: 'ii, iii, v',
          B: 'i, iv, v',
          C: 'i, iv, vi',
  ...
  {
    id: 6,
    title: 'Vignette for questions 25-29',
    vignette: 'Common context for these questions goes here.',
    questions: [
      {
        id: 25,
        text: 'Q25. Which of the following would the physiotherapist note on assessment to confirm the presence of akinesia?',
        options: {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 32,
        text: 'Q32. Before participating in exercise testing and an exercise program, patients need to be screened to determine their risk(s). The physiotherapist has access to the patient’s past medical history. Which of the following is an absolute contraindication to exercise testing and commencing an exercise training program?',
        options: {
          A: 'Hypoglycemia',
          B: 'Asthma',
          C: 'Angina',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 36,
        text: 'Q36. When performing a lumbar spine scan, it is critical to ensure the patient does not have a serious spinal pathology. Which of the following questions must the physiotherapist ask when ruling out cauda equina syndrome?',
        options: {
      ...
      {
        id: 37,
        text: 'Q37. Based on the patient’s presentation, which of the following is the most likely physiotherapy diagnosis?',
        options: {
          A: 'Disc herniation with nerve root irritation',
          B: 'Minor disc herniation without nerve root involvement',
      ...
      {
        id: 38,
        text: 'Q38. Based on the patient’s diagnosis and current condition, what is the first piece of education that the physiotherapist should include in the patient’s treatment?',
        options: {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 44,
        text: 'Q44. The physiotherapist sees their first patient. They suspect that the patient has a torn meniscus. Where in the SOAP note should the physiotherapist include the patient’s physiotherapy diagnosis?',
        options: {
          A: 'Subjective',
          B: 'Objective',
          C: 'Assessment',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 54,
        text: 'Q54. Which of the following would indicate a positive finding with Gillet’s test?',
        options: {
      ...
      {
        id: 55,
        text: 'Q55. The physiotherapist observes that the patient’s right innominate is anteriorly rotated. How should the physiotherapist proceed with documenting this?',
        options: {
          ...
          D: 'The sacrum is in relative counternutation compared to the right innominate.',
        },
        correctAnswer: 'D',
        explanation:
      ...
      {
        id: 56,
        text: 'Q56. If the patient’s right innominate is anteriorly rotated, what will the findings be when assessing their leg length in the supine to long sitting test?',
        options: {
          ...
          C: 'The right leg will appear longer in supine and shorter in long sitting.',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 69,
        text: 'Q69. How would the percentage change if a 10-year-old child sustained the same burns?',
        options: {
          A: '45%',
          B: '42%',
          C: '37%',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 75,
        text: 'Q75. Where is the anterior interosseous nerve commonly entrapped?',
        options: {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 80,
        text: 'Q80. From what cord of the brachial plexus does the ulnar nerve arise?',
        options: {
          A: 'Lateral cord',
          B: 'Posterior cord',
          C: 'Medial cord',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 98,
        text: 'Q98. Given the suspected diagnosis, which presentation of active movements at the glenohumeral joint will most likely be demonstrated by the patient?',
        options: {
      ...
      {
        id: 99,
        text: 'Q99. The physiotherapist would like to perform a joint mobilization to assist in increasing shoulder abduction. What position should the physiotherapist position the patient’s arm in?',
        options: {
          A: '30 degrees of abduction and 55 degrees of horizontal adduction',
          B: '20 degrees of abduction and 70 degrees of horizontal adduction',
          C: '55 degrees abduction and 30 degrees horizontal adduction',
          D: '70 degrees of abduction and 20 degrees of horizontal adduction',
        },
        correctAnswer: 'C',
        explanation:
      ...
      {
        id: 100,
        text: 'Q100. The physiotherapist chooses a grade 3 joint mobilization as a starting point to improve shoulder abduction range of motion. As they begin to perform the joint mobilization, the patient reports pain. How should the physiotherapist proceed?',
        options: {
          A: 'Stop performing the technique and avoid using joint mobilizations in the treatment of this patient.',
          B: 'Decrease the intensity of the joint mobilization to a grade 1.',
          C: 'Stop performing the technique and ask the patient about the location of their pain.',
          D: 'Advise the patient that mild pain is normal and continue with the grade 3 joint mobilization.',
        },
        correctAnswer: 'C',
        explanation:
          '<div class="noselect"> <p style="text-align: left"> <strong>Feedback:</strong> </p> <p style="text-align: left"> A. Stop performing the technique and avoid using joint mobilizations in the treatment of this patient. </p> <ul style="text-align: left"> <li> This is incorrect. Joint mobilizations are an effective treatment for individuals with frozen shoulder. </li> </ul> <p style="text-align: left"> B. Decrease the intensity of the joint mobilization to a grade 1. </p> <ul style="text-align: left"> <li> This is correct but it is not the BEST option. It would be important to determine what is causing the patient’s pain before immediately decreasing the intensity of the grade. </li> </ul> <p style="text-align: left"> C. Stop performing the technique and ask the patient about the location of their pain. –<strong> CORRECT</strong> </p> <ul style="text-align: left"> <li> This is the BEST option as it addresses the patient’s pain and looks to determine the cause. Was the pain due to the physiotherapist’s hand placement and not the joint mobilization itself? Before halting the treatment altogether, it would be important to first communicate with the patient. </li> </ul> <p style="text-align: left"> D. Advise the patient that mild pain is normal and continue with the grade 3 joint mobilization. </p> <ul> <li style="text-align: left"> This is incorrect. The physiotherapist should avoid causing pain while performing joint mobilizations. </li> </ul> </div>',
      },
    ],
  },
  {
    id: 22,
    title: 'Vignette for questions 101-107',
    vignette: 'Common context for these questions goes here.',
    questions: [
      {
        id: 101,
        text: 'Q101. What type of multiple sclerosis does the patient have?',
        options: {
      ...
      {
        id: 103,
        text: 'Q103. Which of the following findings would the physiotherapist note during the assessment?',
        options: {
          A: 'Clonus',
          B: 'Decreased ankle dorsiflexion range of motion',
          C: 'Coordination deficits',
          D: 'Cognition deficits',
        },
        correctAnswer: 'A',
        explanation:
          '<p style="text-align: left"> <strong>Feedback:</strong> </p> <p style="text-align: left">A. Clonus<strong> – CORRECT</strong></p> <ul style="text-align: left"> <li> This is the BEST option. All of the options listed can be noted in patients with multiple sclerosis, however, clonus is the only option that is guaranteed to be present. Clonus is a sign of an upper motor neuron lesion and, given the nature of MS where there are lesions within the brain and spinal cord (upper motor neuron lesions), clonus will be present during the assessment. </li> <li> Clonus is an abnormal reflex response that involves involuntary and rhythmic muscle contractions. Clonus is most commonly tested for and noted during a quick stretch of the ankle into dorsiflexion. As a result of the quick stretch, the foot will involuntarily bounce up and down. </li> </ul> <p style="text-align: left"> B. Decreased ankle dorsiflexion range of motion </p> <ul style="text-align: left"> <li> MS can affect a patient’s mobility which can, in turn, result in calf tightness. Spasticity as well as decreased ambulation, step length and time spent standing can all contribute to calf tightness. </li> </ul> <p style="text-align: left">C. Coordination deficits</p> <ul style="text-align: left"> <li> MS can affect coordination leading to issues with functional tasks. </li> </ul> <p style="text-align: left">D. Cognition deficits</p> <ul style="text-align: left"> <li> MS can affect cognitive functioning, leading to problems with memory, attention, and information processing. </li> </ul> <p style="text-align: left"></p>',
      },
      {
        id: 104,
        text: 'Q104. The patient complains of fatigue being a major concern in her ability to manage her household chores. What is the best advice the physiotherapist can provide?',
        options: {
          A: 'Advise the patient to hire a house cleaner.',
          B: 'Take naps frequently throughout the day.',
          C: 'Perform only the necessary household chores when fatigued.',
          D: 'Create a weekly schedule that spreads chores out throughout the week.',
        },
        correctAnswer: 'D',
        explanation:
          '<div class="noselect"> <div class="noselect"> <p style="text-align: left"> <strong>Feedback:</strong> </p> <p style="text-align: left"> A. Advise the patient to hire a house cleaner. </p> <ul style="text-align: left"> <li> This option assumes the patient is comfortable having a stranger in their home and that they can afford the service. It does not promote patient independence and self-management. </li> </ul> <p style="text-align: left"> B. Take naps frequently throughout the day. </p> <ul style="text-align: left"> <li> While this is correct, it is not the BEST option. Napping will not help improve the patient’s daily productivity level. </li> </ul> <p style="text-align: left"> C. Perform only the necessary household chores when fatigued. </p> <ul style="text-align: left"> <li> While this is correct, it is not the BEST option. It does not help the patient formulate an effective solution to managing all of her household duties. </li> </ul> </div> <p style="text-align: left"> D. Create a weekly schedule that spreads chores out throughout the week.<strong> – CORRECT</strong> </p> <ul> <li style="text-align: left"> This is the BEST option as it highlights the importance of pacing and planning. This option provides the patient with the most effective solution for managing all of her household duties. </li> </ul> <div class="noselect"></div> </div>',
      },
      {
        id: 105,
        text: 'Q105. The patient complains of episodes of sharp, shooting, electrical shock-like pain that radiates down along her face, cheek and jaw. What is the most likely cause of this pain?',
        options: {
          A: 'Lesions in the sensory cortex',
          B: 'Demyelination of the facial nerve',
          C: 'Demyelination of the trigeminal nerve',
          D: 'Lesions in the spinothalamic tracts',
        },
        correctAnswer: 'C',
        explanation:
          '<div class="noselect"> <p style="text-align: left"> <strong>Feedback:</strong> </p> <p style="text-align: left">A. Lesions in the sensory cortex</p> <ul style="text-align: left"> <li> Lesions in sensory cortex can occur and can result in altered sensation throughout the body. The description provided in the vignette, however, is specific to trigeminal neuralgia. </li> </ul> <p style="text-align: left"> B. Demyelination of the facial nerve </p> <ul style="text-align: left"> <li> This nerve does not provide sensory innervation to face – only motor innervation to the muscles of facial expression. </li> </ul> <p style="text-align: left"> C. Demyelination of the trigeminal nerve – <strong>CORRECT</strong> </p> <ul style="text-align: left"> <li> The description in the vignette is describing trigeminal neuralgia which is the result of demyelination of the sensory division of the trigeminal nerve which innervates the face, cheek and jaw. Common cranial nerves affected by MS are the optic and trigeminal nerves. </li> </ul> <p style="text-align: left"> D. Lesions in the spinothalamic tracts </p> <ul style="text-align: left"> <li> This does occur and can result in chronic neuropathic pain and can be described as burning pain similar to the pain described by individuals with a pinched nerve. The description provided in the vignette, however, is specific to trigeminal neuralgia. </li> </ul> <p style="text-align: left"> O’Sullivan, S. B., &amp; Schmitz, T. J. (2007). Physical rehabilitation (5th ed.). Pg. 780. Philadelphia: F.A. Davis Company. </p> </div>',
      },
      {
        id: 106,
        text: 'Q106. The patient describes that she can currently walk about 3 blocks with a single cane before becoming fatigued. Which of the following outcomes measures would provide the most accurate assessment of her ambulation endurance?',
        options: {
          A: 'Timed up and go',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 109,
        text: 'Q109. What information in the patient’s history is the most relevant in determining the diagnosis?',
        options: {
          A: 'Both active and passive movements of the spine are restricted.',
          B: 'Pain and stiffness in the lower spine that extends into the thoracic spine.',
          C: 'Pain and stiffness are present for 6 months and improve with exercise but are not relieved by rest.',
          D: 'The patient is 33 years old with no mechanism of injury.',
        },
        correctAnswer: 'C',
        explanation:
          '<div class="noselect"> <p style="text-align: left"> <strong>Feedback:</strong> </p> <p style="text-align: left"> A. Both active and passive movements of the spine are restricted. </p> <ul style="text-align: left"> <li> This is important to note with ankylosing spondylitis (AS) but is not part of the clinical criteria of AS. </li> </ul> <p style="text-align: left"> B. Pain and stiffness in the lower spine that extends into the thoracic spine. </p> <ul style="text-align: left"> <li> This is important to note with AS but is not part of the clinical criteria of AS. </li> </ul> <p style="text-align: left"> C. Pain and stiffness are present for 6 months and improve with exercise but are not relieved by rest. – <strong>CORRECT</strong> </p> <ul style="text-align: left"> <li>This is the clinical criteria of AS.</li> </ul> <p style="text-align: left"> D. The patient is 33 years old with no mechanism of injury. </p> <ul> <li style="text-align: left"> This is important to note with AS but is not part of the clinical criteria of AS. </li> </ul> </div>',
      },
      {
        id: 110,
        text: 'Q110. The physiotherapist measures spinal extension using the smythe test and discovers significant limitations in spinal motion. Which of the three segments measured will show the least amount of change during testing?',
        options: {
          A: 'The first (lowest) segment',
          B: 'The second (middle) segment',
          C: 'The third (highest) segment',
          D: 'There would be no difference between each of the three segments',
        },
        correctAnswer: 'A',
        explanation:
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 114,
        text: 'Q114. The physiotherapist wants to test ankle ligament integrity and performs the anterior drawer test in supine. Which of the following correctly describes the anterior drawer test?',
        options: {
          A: 'The examiner stabilizes the foot and talus, holds the foot in 20 degrees of plantarflexion and draws the tibia and fibula forwards in the ankle mortise.',
          B: 'The examiner stabilizes the tibia and fibula, holds the foot in 20 degrees of plantarflexion and draws the talus forwards in the ankle mortise.',
          C: 'The examiner stabilizes the foot and talus, holds the foot in 90 degrees of plantarflexion and draws the tibia and fibula forwards in the ankle mortise.',
          D: 'The examiner stabilizes the tibia and fibula, holds the foot in 90 degrees of plantarflexion and draws the talus forwards in the ankle mortise.',
        },
        correctAnswer: 'B',
        explanation:
      ...
      {
        id: 115,
        text: 'Q115. The examiner suspects that the patient may also have a syndesmotic ankle sprain. Which special test should they perform next to confirm this?',
        options: {
          A: 'Talar tilt test',
      ...
      {
        id: 117,
        text: 'Q117. During a physiotherapy session, the patient states that they are nervous about returning to basketball as they play for a high level elite basketball team. The patient discloses that they have a history of anxiety and depression. They ask the physiotherapist to not include this information in their chart because if someone found this information out, it could affect their ability to stay on the team. How should the physiotherapist proceed?',
        options: {
          A: 'Advise the patient that all information about their medical health and physiotherapy treatment must be documented in their chart.',
          B: 'Inform the patient that the information will be documented but never shared.',
          C: 'Gain more insight from the patient as to why they feel that they would be cut from the team due to their anxiety and/or depression.',
          D: 'Respect the patient’s wishes and do not document anything related to the patient’s anxiety and/or depression.',
        },
        correctAnswer: 'D',
        explanation:
    ...
    questions: [
      {
        ...
        correctAnswer: 'C',
        explanation:
          '<div class="noselect"> <p style="text-align: left"> <strong>Feedback:</strong> </p> <p style="text-align: left">A. 5 Hz</p> <p style="text-align: left">B. 35 Hz</p> <p style="text-align: left"> C. 100 Hz – <strong>CORRECT</strong> </p> <ul style="text-align: left"> <li> When using HVPC for wound healing, the frequency should be between 80-150 Hz. </li> </ul> <p style="text-align: left">D. 200 Hz</p> <p style="text-align: left"> <em>&nbsp;</em> </p> </div>',
      },
      {
        id: 124,
        text: 'Q124. The patient is now 10 weeks post total hip replacement and their ulcer has healed and they are full weight bearing and able to ambulate with a single point cane. What should the physiotherapist encourage the patient to do when turning around at the end of the hallway?',
        options: {
          A: 'Always turn towards the left.',
          B: 'Always turn towards the right.',
          C: 'Turn in either direction but move slowly.',
          D: 'Turn in either direction and keep the cane in the right hand.',
        },
        correctAnswer: 'B',
        explanation:
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 147,
        text: 'Q147. The patient is now 3 weeks post op. What goals should we expect at this stage of healing?',
        options: {
          A: 'No symptoms of swelling',
          B: 'Available knee range of motion from 10-60 degrees',
          C: 'Pain free active range of motion',
          D: 'Full weight bearing with ambulation',
        },
        correctAnswer: 'D',
        explanation:
  ...
  {
    id: 31,
    title: 'Vignette for questions 148-151',
    vignette: 'Common context for these questions goes here.',
    questions: [
      {
        id: 148,
        text: 'Q148. The patient asks the physiotherapist about their opinion given the present signs and symptoms. What diagnosis should the physiotherapist be most concerned about?',
        options: {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: 'B',
        explanation:
          '<div class="noselect"> <p style="text-align: left"> <strong>Feedback:</strong> </p> <p style="text-align: left">A. Myositis ossificans</p> <ul style="text-align: left"> <li> Myositis ossificans does not develop within hours to days post injury. </li> </ul> <p style="text-align: left"> B. Acute compartment syndrome <strong>– CORRECT</strong> </p> <ul style="text-align: left"> <li> Acute compartment syndrome is the greatest concern post muscle contusion. Uncontrolled bleeding can result in increased pressure within the compartment of the thigh and disrupt blood flow to the tissues within that compartment. Acute compartment syndrome is a medical emergency. </li> </ul> <p style="text-align: left">C. Chronic compartment syndrome</p> <p style="text-align: left">D. Ecchymosis</p> <ul style="text-align: left"> <li> Eccymosis is the medical term for bruising which is a normal occurrence after a muscle contusion. The physiotherapist should be goal oriented to decrease the amount of bruising through the use of ice and compression. </li> </ul> <p style="text-align: left"></p> </div>',
      },
      {
        id: 167,
        text: 'Q167. The patient is now several days post injury. Which of the following is the correct prescription for their quadriceps setting exercises?',
        options: {
          A: 'Perform 2 sets of 10 reps with a 5-second hold 4 times a day.',
          B: 'Perform 3 sets of 15 reps with a 10-second hold once daily.',
          C: 'Perform 3 sets of 20 reps with a 5-second hold 2 times a day.',
          D: 'Perform 2 sets of 20 reps with a 10-second hold once daily.',
        },
        correctAnswer: 'A',
        explanation:
          '<div class="noselect"> <p style="text-align: left"> <strong>Feedback:</strong> </p> <p style="text-align: left"> A. Perform 2 sets of 10 reps with a 5-second hold 4 times a day. <strong>– CORRECT</strong> </p> <ul style="text-align: left"> <li> When initially starting to activate the affected muscle, it would be BEST for the patient to perform smaller sets/reps more frequently throughout the day. For this reason, this is the BEST option. </li> </ul> <p style="text-align: left"> B. Perform 3 sets of 15 reps with a 10-second hold once daily. </p> <p style="text-align: left"> C. Perform 3 sets of 20 reps with a 5-second hold 2 times a day. </p> <p style="text-align: left"> B. Perform 2 sets of 20 reps with a 10-second hold once daily. </p> <p style="text-align: left"></p> </div>',
      },
    ],
  },
  {
    id: 35,
    title: 'Vignette for questions 168-169',
    vignette: 'Common context for these questions goes here.',
    questions: [
      {
        id: 168,
        text: 'Q168. During the examination, the physiotherapist notes that, in addition to the buttocks pain, the patient also presents with referral pain. Based on the referral pattern typically seen in piriformis syndrome, where would the patient report pain?',
        options: {
          A: 'Lateral aspect of thigh',
          B: 'Anteromedial aspect of thigh',
          C: 'Posterior aspect of the thigh',
          D: 'Groin',
        },
        correctAnswer: 'C',
        explanation:
